function [x,fx] = metodo_aureo(f,a,b,E)
% Función x = metodo_aureo(f,a,b,E)
% Método de la sección de oro para hallar el único máximo de una función f 
% que se encuentra en el intervalo [a,b]
% ARGUMENTOS DE ENTRADA:
%   f .....  Función numérica de la que se busca el máximo
